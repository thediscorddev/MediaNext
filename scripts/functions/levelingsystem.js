...
xprequire = xprequire + 5
     ...
     //       Did you made the Level up message which is <Ping> GG! you've leveled up to **Level <Level>** thingy?
          });
          if (xp > xprequire) {
            message.channel.send(` ${message.author} GG! you've leveled up to **${level + 1}**`)
			let nlevel = level + 1;
